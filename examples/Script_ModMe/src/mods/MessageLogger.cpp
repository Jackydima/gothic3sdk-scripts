...
class mCGothicLogger
{
  ...
  protected:
    static GEBool GE_STDCALL g_MessageCallback(bEMessageTypes a_enumType, GELPCChar a_pcMessage, GELPCChar a_pcReserved,
                                               GEU32 a_u32Parameter, GELPCChar a_pcFile, GEInt a_iLine,
                                               GEInt a_iPriority);

  protected:
    GEBool OnMessageCallback(bEMessageTypes a_enumType, GELPCChar a_pcMessage, GELPCChar a_pcReserved,
                             GELPCChar a_pcFile, GEInt a_iLine, GEInt a_iPriority);
};

void mCGothicLogger::Register()
{
    bCMessageAdmin::GetInstance().RegisterCallback(mCGothicLogger::g_MessageCallback, bEMessageCallbackPriority_Normal,
                                                   reinterpret_cast<GEU32>(this));
}

GEBool GE_STDCALL mCGothicLogger::g_MessageCallback(bEMessageTypes a_enumType, GELPCChar a_pcMessage,
                                                    GELPCChar a_pcReserved, GEU32 a_u32Parameter, GELPCChar a_pcFile,
                                                    GEInt a_iLine, GEInt a_iPriority)
{
...
GEBool mCGothicLogger::OnMessageCallback(bEMessageTypes a_enumType, GELPCChar a_pcMessage, GELPCChar a_pcReserved,
                                         GELPCChar a_pcFile, GEInt a_iLine, GEInt a_iPriority)
{
